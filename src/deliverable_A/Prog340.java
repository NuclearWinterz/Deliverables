...
**/
  public Prog340() {
	...
	inputFile = null;
   	...
   	comboBoxList[2] = new String ("Deliv B:  Write Heap Info");
   	comboBoxList[3] = new String ("Deliv C:  Uniform Cost Search");
   	comboBoxList[4] = new String ("Deliv D1:  D1: Read Heuristic Graph");
   	comboBoxList[5] = new String ("Deliv D2:  A* Search");
   	comboBoxList[6] = new String ("Deliv E:  Genetic Algorithm");
  ...
  public void actionPerformed( ActionEvent e ) {
	  ...
	  case 1:
	  	...
	  	case 5:
	  		DelivD dD = new DelivD( inputFile, g, h );
	  		break;	  		
